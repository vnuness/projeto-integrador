...
public class TesteVocacional {
   public static Scanner input = new Scanner(System.in);
    ...
    public static void main(String[] args) {
        int opcao = 0, A = 0, B = 0, C = 0, D = 0, E = 0;
        String tmp = null;
        ...
        System.out.println("Olá Fulano, recebemos seus dados de inscrição com sucesso !\n"
                ...
                + "Para efeito desta pesquisa foram analisados os seguintes testes:"
                + " on-line4; Globo online5; Guia do Estudante6; Teste Vocacional Grátis7; Mundo Profissional8."
                + " Teste Vocacional Guia da Carreira; Vestibuol.  "
                + "");
        ...
        for (int i = 1; i <= 19; i++) {
            ...
            switch (i) {
                ...
                case 12:
                    ...
                    break;
                case 13:
                    System.out.println("O professor que mais me influenciou até hoje foi o que:");
                    System.out.println("A) Me ajudou a descobrir novos interesses e talentos.\n"
                    ...
                    break;
                case 14:
                    System.out.println("Se eu fosse trabalhar nas férias, escolheria uma atividade que:");
                    System.out.println("A) Me permitisse fazer coisas que mais gosto. \n"
                ...
                tmp = input.next();
                    break;
                case 15:
                    System.out.println("O grande sonho da minha vida é:");
                    System.out.println("A) Poder desenvolver plenamente meus talentos e habilidades.\n"
                            + "B) Ser reconhecido como o melhor naquilo que faço.\n"
                    ...
                    break;    
                case 16:
                    System.out.println("A pior coisa para mim é: ");
                    System.out.println("A) Ser obrigado a fazer coisas que não têm nada a ver comigo.\n"
                    ...
                    break;
                case 17:
                    System.out.println("Gosto principalmente de esportes que:	");
                    System.out.println("A) Permitem que eu me descontraia e aproveite os amigos.\n"
                    ...
                    break;
                case 18:
                    System.out.println("Revistas e livros são antes de mais nada: ");
                    System.out.println("A) Fontes de informação e de conhecimentos sobre os assuntos que me interessam.\n"
                    ...
                    break;  
                case 19:
                    System.out.println("Meus amigos sempre me procuram quando:	");
                    System.out.println("A) Precisam de uma opinião sobre assuntos pelos quais me interesso.\n"
                            + "B) Querem saber sobre o que está na moda .\n"
                            + "C) Querem contar algo que aconteceu com eles.\n"
                            + "D) Precisam de uma orientação sobre a compra de alguma coisa.\n"
                            + "E) Estão em dificuldades e precisam de ajuda.\n");
                    tmp = input.next();
                    break;
